...
% These row vectors are stacked on top of one another to get two data matrices, each with 4096 columns.
% The first matrix cats consists of all the cat images as row vectors and the second matrix dogs consists of all the dog images as row vectors.

function [cats dogs] = PA_3_3_Read_cats_dogs
