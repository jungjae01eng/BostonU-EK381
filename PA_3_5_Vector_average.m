...
% This function takes in a data matrix and outputs the average row vector.

function row_avg = PA_3_5_Vector_average(datamatrix)
    [m,n] = size(datamatrix);       % m is a row, n is a column
